...
urlpatterns = [
    ...
    path('ssl-payment-request/ssl-payment-success/', views.ssl_payment_success,name='ssl-payment-success'),
    path('ssl-payment-request/ssl-payment-fail/', views.ssl_payment_fail, name='ssl-payment-fail'),
    path('ssl-payment-request/ssl-payment-cancel/', views.ssl_payment_cancel, name='ssl-payment-cancel'),
